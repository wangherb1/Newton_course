...
const demoSrc = assetPath('/demos/book1_chapter02/prop001_theorem001/equal_area_demo.html');
  ...
  return (
    <figure className="area-law-demo-frame">
      ...
      <figcaption className="area-law-demo-frame__caption">
        <span>
          椭圆轨道以焦点 S 为固定力心。相等时间间隔内，短连线对应较大的转角，
          长连线对应较小的转角，而焦点连线扫过的面积保持相等。
        </span>
        <a href={demoSrc} target="_blank" rel="noreferrer">Open full demo</a>
      </figcaption>
    </figure>
  );
}
